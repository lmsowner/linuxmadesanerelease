...
internal static class AiProviderRuntimeFactory
{
    public static IAiProvider Create(
        ...
        settings.ProviderType switch
        {
            ...
            AiProviderType.LinuxMadeSaneAiService => new CustomOpenAiCompatibleAiProvider(settings.ProviderKey, definition, settings, models, secretStore, httpClientFactory),
