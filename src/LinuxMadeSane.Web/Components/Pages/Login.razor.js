...
for (const form of forms) {
    ...
    const submitWhenComplete = () => {
        if (isSubmitting || !/^\d{6}$/.test(otpInput.value)) {
            return;
        }
